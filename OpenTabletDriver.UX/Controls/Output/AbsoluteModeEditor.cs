                        ...
                        new ActionCommand
                        {
                            ...
                            Action = () =>
                            {
                                ...
                                else
                                {
                                    ...
                                    Console.WriteLine("(virtualScreen.Position.X, virtualScreen.Position.Y): (" + virtualScreen.Position.X.ToString() + ", " + virtualScreen.Position.Y.ToString() + ")");
                                    Console.WriteLine("(xOffset, yOffset): (" + xOffset.ToString() + ", " + yOffset.ToString() + ")");
                                    Console.WriteLine("(display.Width, display.Height): (" + display.Width.ToString() + ", " + display.Height.ToString() + ")");
                                    Console.WriteLine("(display.Position.X, display.Position.Y): (" + display.Position.X.ToString() + ", " + display.Position.Y.ToString() + ")");

                                    Console.WriteLine("Result (current 0.6.x 1564de3): (" + (display.Position.X - xOffset + virtualScreen.Position.X + (display.Width / 2)).ToString() + ", " + (display.Position.Y - yOffset + virtualScreen.Position.Y + (display.Height / 2)).ToString() + ")");
                                    Console.WriteLine("Result (method in PR currently as 2fb76a1): (" + (display.Position.X + virtualScreen.Position.X + (display.Width / 2)).ToString() + ", " + (display.Position.Y + virtualScreen.Position.Y + (display.Height / 2)).ToString() + ")");
                                    Console.WriteLine("Result (method in other PR using calculated offsets): (" + (display.Position.X - xOffset + (display.Width / 2)).ToString() + ", " + (display.Position.Y - yOffset + (display.Height / 2)).ToString() + ")");
